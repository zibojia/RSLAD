...
Note the KL implementation issue. Since the KL is defined as: <img src="http://chart.googleapis.com/chart?cht=tx&chl= D_{KL} = -\sum_{i=0}^{n} P(i)ln(\frac{Q(i)}{P(i)})" style="border:none;">, the pytorch default implementation: <img src="http://chart.googleapis.com/chart?cht=tx&chl= D_{KL} = -\frac{1}{n}\cdot\sum_{i=0}^{n} P(i)ln(\frac{Q(i)}{P(i)})" style="border:none;">. For CIFAR-10, **n=10**, <img src="http://chart.googleapis.com/chart?cht=tx&chl= D_{KL} = -\frac{1}{10}\cdot\sum_{i=0}^{10} P(i)ln(\frac{Q(i)}{P(i)})" style="border:none;">, for CIFAR-100, **n=100**, <img src="http://chart.googleapis.com/chart?cht=tx&chl= D_{KL} = -\frac{1}{10}\cdot\sum_{i=0}^{10} P(i)ln(\frac{Q(i)}{P(i)})" style="border:none;">
